...
pw.print("नाव"+"</th><th scope='col'>"+"पत्ता"+"</th><th scope='col'>"+"मोबाईल क्र."+"</th><th scope='col'>"+"जन्मतारीख"+"</th><th scope='col'>"+"ईमेल"+"</th><th scope='col'>"+
"नातेवाईककांचे नाव"+"</th><th scope='col'>"+"मोबाईल क्र."+"</th><th scope='col'>"+"संबंध"+"</th><th scope='col'>"+"नातेवाईकांचे पत्ता"+"</th><th scope='col'>"+"हॉस्पिटलचे नाव"+"</th><th scope='col'>"+"नाॊंदणी क्रमांक"+"</th><th scope='col'>"+"स्थिती");
...
%>
	...
	<span style="float: left"><a href="Data.jsp?pgno=<%= Math.max(0, pgno - 1) %>"
			class="btn btn-dark <%= (start == 0) ? "disabled" : "" %>">मागे</a></span>
	<span style="float: right"><a href="Data.jsp?pgno=<%= Math.min((total - 1) / recordCount, pgno + 1) %>"
			class="btn btn-dark <%= (start + recordCount >= total) ? "disabled" : "" %>">पुढे</a></span>
