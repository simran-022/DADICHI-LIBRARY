...
pw.print("नाम"+"</th><th scope='col'>"+"पता"+"</th><th scope='col'>"+"मोबाइल नं."+"</th><th scope='col'>"+"जन्म तिथि"+"</th><th scope='col'>"+"ईमेल"+"</th><th scope='col'>"+
"रिश्तेदार का नाम"+"</th><th scope='col'>"+"मोबाइल नं."+"</th><th scope='col'>"+"रिश्ता"+"</th><th scope='col'>"+"रिश्तेदार का पता"+"</th><th scope='col'>"+"अस्पताल का नाम"+"</th><th scope='col'>"+"पंजीकरण संख्या"+"</th><th scope='col'>"+"स्थिति");
...
%>
	...
	<span style="float: left"><a href="Data.jsp?pgno=<%= Math.max(0, pgno - 1) %>"
			class="btn btn-dark <%= (start == 0) ? "disabled" : "" %>">पहले</a></span>
	<span style="float: right"><a href="Data.jsp?pgno=<%= Math.min((total - 1) / recordCount, pgno + 1) %>"
			class="btn btn-dark <%= (start + recordCount >= total) ? "disabled" : "" %>">अगला</a></span>
